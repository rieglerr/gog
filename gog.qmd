...
Wickham (2008) operationalised this idea by writing the ggplot2 package that is based on this layered approach, and we are going to use the package today! The ggplot packages follows a layered approach, 
